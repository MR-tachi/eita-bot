import sqlite3
import json
from bale import Update, ReplyKeyboardMarkup, ReplyKeyboardRemove
from bale.ext import Application, CommandHandler, MessageHandler, filters, ConversationHandler, CallbackContext

# تنظیمات اولیه
TOKEN = "YOUR_BALE_BOT_TOKEN"  # توکن ربات بله را اینجا قرار دهید
CHANNEL_LINK = "https://ble.ir/YOUR_CHANNEL"  # لینک کانال بله را اینجا قرار دهید 
MAX_ATTEMPTS = 2
...
def complete_form(update: Update, context: CallbackContext):
    ...
    update.message.reply_text(f"📢 {CHANNEL_LINK}")
